...
// Konstanta PID Steer
const double Kp_steer = 0.82;  // 0.82
const double Kd_steer = 0.2;   // 0.2

// Konstanta PID Drive
const double Kp_drive = 0.04;  //0.04
const double Ki_drive = 0.5;     // 0.5
const double Kd_drive = 0.0141;     //0.0141
